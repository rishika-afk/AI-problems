    ...
    while (currentState != goalState):
        if (location == "A"):
            ...
            if (currentState["A"] == 1):
                ...
                printInformation("A")
            # moving
            if (currentState["B"] == 1 or currentState["C"] == 1 or currentState["D"] == 1):
            ...
            if (currentState["A"] == 1 or currentState["B"] == 1):
                ...
                print("Moving right to the location D.\nCost for moving RIGHT: 1")
                location = "D"
                totalCost += 1
            ...
            if (currentState["D"] == 1):
                ...
                printInformation("D")
            # moving
            if (currentState["A"] == 1 or currentState["B"] == 1  or currentState["C"] == 1):
